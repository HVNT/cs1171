...
function [A B C D] = ABCs_structureArrays(str1, str2, str3, sa1)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
carA = struct('make', 'Honda', 'model', 'Accord', 'color', 'silver');
carB = struct('make', 'BMW', 'model', '335i', 'color', 'silver');
carC = struct('make', 'Volvo', 'model', 'C70', 'color', 'silver');
D = [carA, carB, carC];
