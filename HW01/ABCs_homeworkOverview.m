...
function [A B C D E F G H I J K L M N O P Q R] = ABCs_homeworkOverview(a, b, c)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% 6. After I submit my assignment I should always check to see if I
...
% 9. If T-square crashes, I should e-mail my code to my TA.
I = true;
...
% 12. I am required to turn in something for the second submission.
L = false;
...
% 16. Take the absolute value of the number in variable 'b'.
abs(b);

% 17. Take the cosine value of the number in variable 'b' (in radians).
cos(b);

% 18. Take the modulus after division of the numbers contained in variables
